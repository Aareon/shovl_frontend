$("#record-create").click(function(){
  ...
  if (type == "MX"){
      ...
      req = {hostname: name+$_GET("id"), protected: $("shield-box").prop(('checked')), type: type, record_srv_target: $("#record-srv-target").val(), record_srv_protocol: $("#record-srv-protocol").val(), record_srv_port: $("#record-srv-port").val(), record_srv_weight: $("#record-srv-weight").val()};
  }
  $.ajax({
     type:"POST",
