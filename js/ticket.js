	 ...
	 isloggedin();
         $.ajax({
            ...
            success: function(result) {
				...
				p.append('<div class="panel panel-primary">'+'<div class="panel-heading"><i class="fa fa-user"></i> '+data.creator+'</div>'+'<div class="panel-body">'+htmlEntities(data.message)+"<br>Sent: "+convertTimestamp(data.create_stamp)+"</div>");
				$('#message_box').html(p);
            },
