          ...
          <div class="container-fluid">
              <div class="row">
                  ...
                  <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#profile_div">Profile</a></li>
                    <li><a data-toggle="tab" href="#password_div">Password</a></li>
                  </ul>
                  <!-- End of navbar -->
                  ...
                  <div class="tab-content">
                    ...
                    <button id="update-profile" class="btn btn-primary btn-block">Update Profile</button>
                  </div>

                    <div id="password_div" class="tab-pane fade">
